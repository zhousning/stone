class DesignerElectric < ActiveRecord::Base
  include ModelBase
  ...
  has_many :designer_electric_certs, :dependent => :destroy
  accepts_nested_attributes_for :designer_electric_certs, reject_if: :all_blank, allow_destroy: true
